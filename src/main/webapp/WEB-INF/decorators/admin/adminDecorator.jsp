...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="${adminResRoot}/css/plugins/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="${adminResRoot}/css/sb-admin-2.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="${adminResRoot}/font-awesome-4.1.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
